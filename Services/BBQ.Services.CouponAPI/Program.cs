...
var connectionString = builder.Configuration.GetConnectionString("CouponDefaultConnection");
...
{
    c.SwaggerDoc("v1", new OpenApiInfo {Title = "BBQ.Services.CouponAPI"});
    c.EnableAnnotations();
